...
const MemoryModeration = ({ authHeaders, showToast }) => {
    ...
    return (
        <div style={pageContainer}>
            ...
            {/* 2. Stats Cards */}
            <div style={statsGrid}>
                <StatsCard title="Total Memory Posts" value={stats.total} icon={<ImageIcon size={24} />} color="#1E3A8A" />
            ...
            <div style={layoutGrid}>
                ...
                <div style={rightColumn}>
                    ...
                    <div style={tipCard}>
                        <Shield size={24} color="#1E3A8A" style={{marginBottom: '12px'}} />
...
const avatarSmall = { width: '28px', height: '28px', borderRadius: '8px', background: '#E0E7FF', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', fontWeight: '800', color: '#1E3A8A' };
...
const viewAllBtn = { width: '100%', marginTop: '20px', padding: '10px', borderRadius: '12px', border: '1px solid #F1F5F9', background: '#F8FAFC', color: '#1E3A8A', fontWeight: '700', fontSize: '13px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' };
